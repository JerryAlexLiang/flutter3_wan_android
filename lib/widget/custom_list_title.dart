...
/// 创建日期: 2025/04/29 14:06
/// 作者: Jerry
/// 描述: 自定义组件 CustomListTitle，实现多种布局类型的ListTitle Widget
/// 说明：
...
class CustomListTitle extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Material(
      ...
      child: InkWell(
        splashColor: splashColor ?? Colors.transparent.withValues(alpha: 0.1),
        ...
        child: Offstage(
          ...
          child: Column(
            ...
            children: [
              Text(
                title ?? "",
                style: titleStyle ?? context.bodyLargeStyle,
                maxLines: maxLines,
