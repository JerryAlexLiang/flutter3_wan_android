...
import 'package:flutter3_wan_android/http/base_url_reuqest_interceptors.dart';
import 'package:flutter3_wan_android/http/dio_interceptors.dart';
...
class DioUtil {
  ...
  /// 连接超时时间
  static int connectTimeout = 6 * 1000;

  /// 响应超时时间
  static int receiveTimeout = 6 * 1000;
